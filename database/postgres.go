...
func Migrate(db *gorm.DB) {
	// db.Migrator().DropTable(&domain.User{}, &domain.Profile{}, &domain.Cart{}, &domain.Category{}, &domain.Product{}, &domain.Book{}, &domain.LearningSupply{}, &domain.OfficeSupply{}, &domain.Order{}, &domain.OrderItem{}, &domain.CartItem{}, &domain.ProductCategory{}, &domain.ProductImage{}, &domain.Group{}, &domain.GroupProduct{}, &domain.Tag{})
